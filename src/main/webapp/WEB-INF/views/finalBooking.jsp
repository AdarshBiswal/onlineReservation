...
<html>
<head>
<title>ZLINE :: BOOING SUCCESSFULL</title>
...
<div class="content">
	...
	<div class="main" style="width:50%;">
		...
		<table class="table">
  				<thead >
    			<tr>
      				<th scope="col" style=" text-align:center;color:red;">YOUR TICKET IS BOOKED SUCCESSFULLY</th>
    			</tr>
  				</thead>
  		</table>
		<table class="table">
    		...
    		<tr>
      			<th scope="col" style=" text-align:center;">NAME: ${firstName} ${lastName}</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
  			<thead class="thead-dark">
    		<tr>
      			<th scope="col" style=" text-align: left;">Email: ${email}</th>
      			<th scope="col" style=" text-align: right;">Mobile: ${mobile}</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
  			<thead class="thead-dark">
    		<tr>
      			<th scope="col" style="text-align: left;">From: ${fromCity}</th>
      			<th scope="col" style="text-align: right;">To: ${toCity}</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
  			<thead class="thead-dark">
    		<tr>
      			<th scope="col" style="text-align: left;">Date: ${JDate}</th>
      			<th scope="col" style="text-align: right;">Time: ${busTime}</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
  			<thead class="thead-dark">
    		<tr>
      			<th scope="col" style="text-align: left;">Bus Name: ${busName}</th>
      			<th scope="col" style="text-align: right;">Bus Type: AC Sleeper</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
  			<thead class="thead-dark">
    		<tr>
      			<th scope="col" style="text-align: left;">Seat No: ${selectedSeat}</th>
      			<th scope="col" style="text-align: right;">Total Price: Rs ${finalPrice}</th>
    		</tr>
  			</thead>
  		</table>
  		<table class="table">
